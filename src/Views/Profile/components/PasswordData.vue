...
<template>
    <div class="row-text">
        ...
        <Modal v-if="input" @close-modal="openCloseModal" nameModal="Изменить пароль">
            <div class="modal-body" >
                <label v-if="!nextStep">
                    <span>Введите текущий пароль:</span>
                    <input type="password" class="form-control" v-model="currentPassword" placeholder="Пароль">
                </label>

                <label v-else>
                    <span>Введите новый пароль:</span>
                    <input type="password" class="form-control" v-model="newPassword" placeholder="Пароль">
